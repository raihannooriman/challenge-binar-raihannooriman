        ...
        <div className="row row-cols-md-2 row-cols-1 gy-4 gx-4">
          ...
          <div className="align-self-center">
            <h2 className="fs-2 fw-bold">
              Best Car Rental for any kind of trip in Banjarmasin!
            </h2>
            <p className="mt-4">
              Sewa mobil di Banjarmasin bersama Binar Car Rental jaminan harga
            ...
            <ul className="list-group list-group-flush gap-3">
              <li className="d-inline-flex">
                ...
                <span>Sewa Mobil Dengan Supir di Banjarmasin 12 Jam</span>
              </li>
              <li className="d-inline-flex">
                <ChecklistIcon className="me-3" />
                <span>Sewa Mobil Lepas Kunci di Banjarmasin 24 Jam</span>
              </li>
              <li className="d-inline-flex">
                <ChecklistIcon className="me-3" />
